...
export default function ThemeToggle() {
  ...
  return (
    <button
      ...
      className="ml-auto border-none shadow-xl relative flex items-center justify-center w-16 h-8 rounded-full bg-gradient-to-r from-buttonp to-buttona shadow-lg cursor-pointer overflow-hidden"
    >
      {/* Sliding circle */}
      <span
